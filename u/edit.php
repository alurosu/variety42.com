...
if(isset($_POST['edit'])){
    if(strlen($_POST['text'])>0){
        ...
        $message = 'Done! <a href="'.$config->single.'/'.$id.'" target="_blank"> Click Here </a>';
    }
}
?>
...
<body>
    ...
    <div class="wrapper user">
        <h3>Edit <?php echo $folder." - id: ".$id;?><div class="edit_notification"> <?php echo $message; ?></div></h3>
        <?php
        ...
        if ($result->num_rows > 0) {
            ...
            <form action="" method="post">
                <textarea name="text"><?php echo $single['text'];?></textarea>
                <ul class="tags">
                    <?php
