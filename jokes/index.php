...
<head>
	...
	<title><?php echo sprintf($config->seo->firstPage->title, $page); ?></title>
	<meta name="description" content="<?php echo $config->seo->firstPage->description; ?>">

	<meta property="og:title" content="<?php echo sprintf($config->seo->firstPage->title, $page); ?>">
    ...
    <div class="wrapper">
        ...
        <div class="breadcrumbs">
            <ul>
                ...
                <li> <a href="<?php echo $config->folder; ?>" title="Jokes">Jokes</a></li>
            </ul>
        </div>
        <?php
        $nr_per_page = 20;
