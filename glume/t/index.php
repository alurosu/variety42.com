...
<head>
	...
	<meta name="description" content="<?php echo sprintf($config->seo->tagPage->description, $tag['name']); ?>">

	<meta property="og:title" content="<?php echo sprintf($config->seo->tagPage->title, $tag['name'], $page); ?>">
	<meta property="og:type" content="website" />
	<meta property="og:description" content="<?php echo sprintf($config->seo->tagPage->description, $tag['name']); ?>">
