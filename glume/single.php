...
$sql = "SELECT c.text as text, c.likes as likes, c.dislikes as dislikes, c.date as date, u.user as author FROM content c, users u WHERE c.user_id = u.id AND c.id = ".$id;
